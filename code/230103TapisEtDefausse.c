...
struct carte poseCarte(joueur *j) {
  int choix;
  do {
  ...
  } while (choix < 0 || choix > j->nbCartes);
...
void joueurJoue (joueur *j, int nbJoueurs) {
  int choix;
  do {
